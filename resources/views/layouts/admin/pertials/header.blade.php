        ...
        <div class="navbar-right">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ route('front.index') }}" class="icon-menu d-none d-sm-block d-md-none d-lg-block"><i class="fa icon-globe"></i></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" class="icon-menu"><i class="icon-login" onclick="event.preventDefault();
